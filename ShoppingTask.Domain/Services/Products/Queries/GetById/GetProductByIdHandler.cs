...
public class GetProductByIdHandler(IUnitOfWork unitOfWork) : IRequestHandler<GetProductByIdRequest, Result<GetProductByIdResponse?>>
{
    ...
    {
        var product = await _unitOfWork.Products.Find(p => p.Id == request.ProductId)
